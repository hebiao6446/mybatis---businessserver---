						...
						<table class="table table-bordered table-striped">
							<thead>
								<tr>
									...
									<th width="35%" style="font-size: 12px;">职务名称</th>
									<th width="35%" style="font-size: 12px;">上级职务名称</th>									
		...
		<div class="span4" style="margin: 0 16px;">
			<div class="widget-box" style="width: 365px;">
				<div class="widget-title">
					...
					<h5 id="title">职务级别信息修改</h5>
				</div>
				<div class="widget-content nopadding">
					<form class="form-horizontal">
						<div class="control-group">
							<label class="control-label" style="width: 100px;">职务名称：</label>
			...
			<div class="widget-box" style="width: 365px;">
				...
				<div class="widget-content nopadding">
					<form class="form-horizontal">
						...
						<div class="control-group">
							<label class="control-label" style="width: 100px;">所属职务：</label>
							<div class="controls" style="margin-left: 10px;">
							...
							for ( var i = 0; i < msg.rows.length; i++) {
								...
								if(data["parentId"]==0){
									...
									for(var j=0;j< msg.rows.length; j++){
										if(data["parentId"]==msg.rows[j]["roleId"]){
											array.push('<td style="text-align:center;">'+msg.rows[j]["name"]+'</td>');
										}										
									}
								}						
